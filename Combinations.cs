...
namespace Combinations
{
	public class Combinations : Mod
	{
        ...
        public override void AddRecipes()
        {
            ...
            Recipe recipe5 = CreateRecipe(ItemID.JellyfishNecklace);
            ...
            Recipe recipe6 = CreateRecipe(ItemID.DivingHelmet);
            ...
            Recipe recipe7 = CreateRecipe(ItemID.DivingHelmet);
